...
class Shape {
    var numberOfSides = 0
    let fancyName = "le Shape"
    func beFancy() -> String {
        return "Voulez vous \(fancyName)"
    }
...
class Circle: NamedShape {
    ...
    init(radiusValue: Double, name: String) {
    ...
    override func simpleDescription() -> String {
        return "A round shape with all points on its perimeter equidistant from its centroid"
    }
}

let circ = Circle(radiusValue: 15.0, name: "Nice circle")
circ.area()
